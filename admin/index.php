...
<div class='span12'>
  ...
  <div class='row-fluid'>
    <div class='span12 box'>
      ...
      <p style='text-align:justify; text-indent:20px'>Guru berprestasi adalah guru yang memiliki kemampuan melaksanakan tugas,
keberhasilan dalam melaksanakan tugas, memiliki kepribadian yang sesuai dengan
profesi guru dan memiliki wawasan kependidikan sehingga secara nyata mampu
meningkatkan mutu proses dan hasil pembelajaran atau bimbingan melebihi yang
dicapai oleh guru lain sehingga dapat dijadikan panutan oleh siswa, maupun
masyarakat sekitarnya. Sekolah SDN Ngagel Rejo yang berlokasi di SUrabaya merupakan bagian dari civitas akademik di lingkungan pendidikan.
Oleh karena itu SDN Ngagel Rejo juga memiliki peran serta dalam meningkatkan
mutu pendidikan terhadap para anak didiknya, kepala sekolah perlu melaksanakan
penyeleksian dalam menentukan guru berprestasi.
<sup>[1]</sup></p>
      ...
      <p style='text-align:justify; text-indent:20px'>Penghargaan dapat diberikan oleh pemerintah, pemerintah daerah, masyarakat, organisasi profesi, dan/atau satuan pendidikan. Penghargaan dapat diberikan pada 
                        tingkat sekolah kecamatan, tingkat kabupaten/kota, tingkat provinsi, dan nasional. Penyelenggaraan pemilihan guru berprestasi jenjang pendidikan SD dilaksanakan secara bertingkat, 
        ...
        <br>
        <b>Catatan:</b>
        <p style='text-align:justify; font-size:12px'>1. Kementerian Pendidikan dan Kebudayaan, 2013.<i> "PEDOMAN PEMILIHAN GURU SD BERPRESTASI TINGKAT NASIONAL"</i>. Jakarta: Kementerian Pendidikan dan Kebudayaan.</p>
      </div>
    </div>
  </div>
